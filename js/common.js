$(function(){
// $('#comment-input-tel').mask('+00 (000) 000-00-00');
...
$('.logo-red').css('opacity','1');logoHoverEnabled=false;});
$('.navbar-collapse#navbar-main').on('hide.bs.collapse',function(){
$('.logo-red').css('opacity','0');logoHoverEnabled=true;});
...
$('#saymail').on('show.bs.modal',function(event){var button=$(event.relatedTarget);
var modal=$(this);
