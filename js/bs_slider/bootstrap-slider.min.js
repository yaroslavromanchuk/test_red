	...
	function (a) {
		...
		if (d = function (a, b) {
			...
			this
				...
				getValue: function () {
				//console.log(this.options.range ? this._state.value : this._state.value[0]);
				...
				setValue: function (a, b, c) {
					...
					this.options.max > this.options.min ? this._state.percentage = [this._toPercentage(this._state.value[0]),
					this._toPercentage(this._state.value[1]),
					100 * this.options.step / (this.options.max - this.options.min)] : this._state.percentage = [0, 0, 100],
					this._layout();
