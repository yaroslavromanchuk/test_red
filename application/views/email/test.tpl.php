                                    ...
                                    <table width=450 cellpadding=20 style="border:1px solid #e4e4e4; margin-left:200px">
                                        <tr>
                                            <td style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; color:#383838;" align="left">
                                                ...
                                                <p>Чтобы получить доступ к Вашим заказам и контактной информации Вы можете сейчас войти в личный кабинет на <a href="http://<?php echo Config::findByCode('domain_name')->getValue();?>/account/login/">http://<?php echo Config::findByCode('domain_name')->getValue();?>/account/login/</a> используя следующие учетные данные:</p>
