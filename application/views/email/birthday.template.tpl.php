                                                ...
                                                <table class="container" style=" background: #fff; font-family: Arial, Helvetica, sans-serif; border-collapse: collapse; margin: 0; margin: 0  auto; padding: 0; width: 650px;">
                                                    ...
                                                    <tr>
                                                        <td style=" margin: 0; padding: 0  16px; vertical-align: middle; text-align: left;" >
                                                            <span class="text-description" style="display: block; font-size: 17px; width: 100%; font-weight: 400; font-family: Arial, Helvetica, sans-serif;">Добрый день, <a href="<?=$this->link?>" style="color: #3e77aa; text-decoration: none;" target="_blank"><?=$this->name?></a></span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td height="16" style="line-height: 16px; height: 16px; padding: 0;">&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        <td style="margin: 0; padding: 0  16px; vertical-align: middle; text-align: left;">
<span class="text-title" style="display: block; font-size: 28px; width: 100%; font-weight: 400; font-family: Arial, Helvetica, sans-serif;">Поздравляем с Днём рождения!</span>
</td>
</tr>
<tr>
                                                        <td height="16" style="line-height: 16px; height: 16px; padding: 0;">&nbsp;</td>
                                                    ...
                                                    <tr>
                                                    <td style="margin: 0; padding: 0  16px; vertical-align: middle; text-align: left;">
      <span class="text-description" style="display: block; font-size: 17px; width: 100%; font-weight: 400; font-family: Arial, Helvetica, sans-serif;">Празднуем вместе с вами! Дарим Вам 200 redcoin на покупки в нашем интернет магазине.<br><span style="display: block;text-align: center"><b> 1 redcoin = 1 грн.</b></span></span>
   </td>
                                                </tr>
<tr>
                                                        <td height="16" style="line-height: 16px; height: 16px; padding: 0;">&nbsp;</td>
                                                    ...
                                                    <tr><td style="margin: 0; padding: 0  16px; vertical-align: middle; text-align: left;">
                                                            <span class="text-description" style="display: block; font-size: 17px; width: 100%; font-weight: 400; font-family: Arial, Helvetica, sans-serif;">  <a href="<?=$this->link?>" style="color: #3e77aa; text-decoration: none;" target="_blank">Воспользоваться</a> зачисленными redcoin, вы можете в период с <?=date("d.m.Y")?> по <?=date("d.m.Y", strtotime("now +6 days"))?></span>
   </td>
</tr>
