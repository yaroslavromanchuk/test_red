...
<div class="row">
	<div class="col-md-10 col-md-offset-1">
		<a href="http://www.red.ua/category/id/85/rasprodazha/?utm_source=site&utm_medium=banner_main&utm_campaign=sale_main">
			<div style="
				height: 396px;
				width: 800px;
				background: url(../img/blocks/16.jpg);
				background-size: 100%;
			">
...
<div class="row">
    <div class="col-md-4" style="width:35%; float: left;">
        <a href="/category/id/39/muzhskaja-odezhda/tenniski-rubashki/">
			<div style="
				width: 320px;
				height: 386px;
				background: url(../img/blocks/115.jpg);
				background-size: 100%;
			">
    ...
    <div class="col-md-4" style="width:30%; float: left;">
        <a href="/category/brand/62">
			<div style="
				width: 270px;
				height: 180px;
				background: url(../img/blocks/215.jpg);
				background-size: 100%;
			">

			</div>
        </a>
        <a href="/category/id/255/odezhda-dlja-buduwih-mam/">
			<div style="
				width: 270px;
				height: 180px;
				background: url(../img/blocks/315.jpg);
				background-size: 100%;
				margin-top: 25px;
			">
    ...
    <div class="col-md-4" style="width:35%; float: left;">
        <a href="/category/id/113/zhenskaja-odezhda/dzhinsy/">
			<div style="
				width: 320px;
				height: 386px;
				background: url(../img/blocks/415.jpg);
				background-size: 100%;
			">
