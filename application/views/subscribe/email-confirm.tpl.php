                                    ...
                                    <table width=450 cellpadding=20 style="border:1px solid #e4e4e4; margin-left:200px">
                                        <tr>
                                            <td style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; color:#383838;" align="left"><p>Кому: <?php echo @$this->post['name'];?></p>
                                                <p>Нажмите на ссылку ниже для подтверждения подписки на рассылку новостей или отказа от неё:</p>
                                                <br/>
                                                <a href="http://<?php echo Config::findByCode('domain_name')->getValue();?>/subscribe/confirm/code/<?php echo $this->code;?>/">http://<?php echo Config::findByCode('domain_name')->getValue();?>/nieuwsbrief/confirm/code/<?php echo $this->code;?>/</a>
                                                </p></td>
                                        </tr>
                                        <tr>
