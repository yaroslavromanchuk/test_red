...
<div id="filter"  class="filter mt-1 col-xs-12 col-sm-12 col-md-12 col-lg-2 col-xl-2 p-2" ><?php if($this->ws->getCustomer()->getId() == 8005){ echo $this->render('finder/filter_new.tpl.php');}else{ echo $this->render('finder/filter.tpl.php');}?></div>
<!--result -->
