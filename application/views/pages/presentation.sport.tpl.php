...
<iframe src="https://www.youtube.com/embed/0vREOnX8Fqg" frameborder="0"  class="video_frame" id="frame">
</iframe>
</p>
<!--меню презентации для мобилных -->
...
<li>             
			  <a href="#comment-modal" data-toggle="modal" onClick="myFunc(<?php echo $this->block_p6[0]->getBlock()?>);">
										<div class="text_top_prod_pr" data-title="Подробнее ...">
                                        <img class="img_horizontal_high try_s m_present" alt="<?php echo $this->block_p6[0]->getName() ?>" src="<?php echo $this->block_p6[0]->getImage() ?>">
                                    </div>
									</a>
									</li>
									<?php } ?>
...
<li>
                                   <a href="#comment-modal" data-toggle="modal" onClick="myFunc(<?php echo $this->block_p8[0]->getBlock()?>);">
										<div class="text_top_prod_pr" data-title="Подробнее ...">
                                        <img class="img_vertical_small try_s m_present" alt="<?php echo $this->block_p8[0]->getName() ?>" src="<?php echo $this->block_p8[0]->getImage() ?>">
                                    </div>
									</a>
									</li>
									<?php }?>								   
...
<div id="menu_6" class="block_p-box">
    ...
    <tr>
		...
		<?php if($this->block_p1->count()> 0){ ?>
                                    <a href="#comment-modal" data-toggle="modal" onClick="myFunc(<?php echo $this->block_p1[0]->getBlock()?>);">
										<div class="text_top_prod_pr" data-title="Подробнее ...">
								<img class="img_vertical_high big" alt="<?php echo $this->block_p1[0]->getName() ?>" src="<?php echo $this->block_p1[0]->getImage() ?>" >
								</div>                                   
								   </a>
								   <?php }?>
...
<?php if($this->block_p6->count()> 0){ ?>             
			 <a href="#comment-modal" data-toggle="modal" onClick="myFunc(<?php echo $this->block_p6[0]->getBlock()?>);">
										<div class="text_top_prod_pr" data-title="Подробнее ...">
                                        <img class="img_vertical_small try_s" alt="<?php echo $this->block_p6[0]->getName() ?>" src="<?php echo $this->block_p6[0]->getImage() ?>">
                                    </div>
									</a>
									<?php } ?>
                               </td>
		...
		<?php if($this->block_p7->count()> 0){ ?>
                                     <a href="#comment-modal" data-toggle="modal" onClick="myFunc(<?php echo $this->block_p7[0]->getBlock()?>);">
										<div class="text_top_prod_pr" data-title="Подробнее ...">
                                        <img class="img_horizontal_high" alt="<?php echo $this->block_p7[0]->getName() ?>" src="<?php echo $this->block_p7[0]->getImage() ?>">
                                    </div>
									</a>
									<?php } ?>
                               </td>
		...
		<?php if($this->block_p8->count()> 0){ ?>
                                   <a href="#comment-modal" data-toggle="modal" onClick="myFunc(<?php echo $this->block_p8[0]->getBlock()?>);">
										<div class="text_top_prod_pr" data-title="Подробнее ...">
                                        <img class="img_vertical_small try_s" alt="<?php echo $this->block_p8[0]->getName() ?>" src="<?php echo $this->block_p8[0]->getImage() ?>">
                                    </div>
									</a>
									<?php }?>
                                </td>
...
<!-- !Comment modal2 -->  
	...
	<div class="modal fade comment-form" id="comment-modal" tabindex="-1" role="dialog" aria-labelledby="comment-modal">
...
<script type="text/javascript">
function myFunc (x) {
$.get('/presentation-sport/id/' + x + '/metod/getframe_sport/',
		function (data) {
