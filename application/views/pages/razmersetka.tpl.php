<div class="popap_blok">
								<div class="mask"
									 onclick="$(this).hide(); $('#rozmerSetka1').toggle('slow', function() {}); $('.popap_blok').hide();">
								</div>
...
?>
													...
													<a href="#" id="tab_5"
														class="<?php if ($this->getShopItem()->category->getSizeType() == 5) echo 'selected'; ?>"
														onclick="$('.tabs_img').hide(); $('.'+$(this).attr('id')).show(); $('.size_tabs a').removeClass('selected'); $(this).addClass('selected'); return false"
													>
													   Верх
													</a>
													<a href="#" id="tab_6"
														class="<?php if ($this->getShopItem()->category->getSizeType() == 6) echo 'selected'; ?>"
														onclick="$('.tabs_img').hide(); $('.'+$(this).attr('id')).show(); $('.size_tabs a').removeClass('selected'); $(this).addClass('selected'); return false"
													>
													   Низ
													</a>
													<a href="#" id="tab_4"
														class="<?php if ($this->getShopItem()->category->getSizeType() == 4) echo 'selected'; ?>"
														onclick="$('.tabs_img').hide(); $('.'+$(this).attr('id')).show(); $('.size_tabs a').removeClass('selected'); $(this).addClass('selected'); return false"
													>
														Обувь
													</a>
