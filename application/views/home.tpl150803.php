...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/style.css?v=20131227"/>
    ...
    <div class="body head-block">
		...
		<div class="row">
			<div class="col-md-4 ico_block">
				<span class="glyphicon glyphicon-thumbs-up top_ico" aria-hidden="true"></span>
				<div class="top_ico_lbl" style="padding-top:22px;">Высокое качество</div>
			</div>
			<div class="col-md-4 ico_block">
...
<div class="row">
	<div class="col-md-10 col-md-offset-1">
		<a href="/category/id/70/zhenskaja-odezhda/platja/">
			<img style="width: 800px" src="../img/banner/1.jpg"/>
		</a>
	</div>
</div>
...
<div class="row">
    <div class="col-md-4" style="width:35%; float: left;">
        <a href="http://www.red.ua/brands/id/250/no-excess">
            <img style="width:100%;" src="/img/banner/2.jpg">
        </a>
    </div>
    <div class="col-md-4" style="width:30%; float: left;">
        <a href="http://www.red.ua/category/id/59/detjam/">
            <img style="width:100%;" src="/img/banner/3.jpg">
        </a>
        <a href="http://www.red.ua/category/id/253/aksessuary/ochki-i-opravy/">
            <img style="width:100%; padding-top: 25px;" src="/img/banner/4.jpg">
        </a>
    </div>
    <div class="col-md-4" style="width:35%; float: left;">
        <a href="http://www.red.ua/category/id/85/rasprodazha/">
            <img style="width:100%;" src="/img/banner/5.jpg">
        </a>
    </div>
</div>
...
<div class="row" style="padding: 0px 30px;">
    ...
    ">
        ...
        <div class="row" style="
            margin-top: 10px;
        ">
            <a class="col-md-4" style="float: left; width: 33%;" href="http://lifestyle.red.ua/2015/07/blog-post_13.html">
                <div class="blog-overlay-placeholder" style="background-image: url('/img/blog/1.jpg');">
                    <div class="blog-cover">
                        <div class="blog-overlay">
                            <span id="hover-text" class="blog_text">Топ 5 женской обуви RED.ua</span>
                        </div>
                    </div>
                </div>
            </a>
            <a class="col-md-4" style="float: left; width: 33%;" href="http://lifestyle.red.ua/2015/07/blog-post_13.html">
                <div class="blog-overlay-placeholder" style="background-image: url('/img/blog/2.jpg');">
                    <div class="blog-cover">
                        <div class="blog-overlay">
                            <span id="hover-text" class="blog_text">Топы от Bershka</span>
                        </div>
                    </div>
                </div>
            </a>
            <a class="col-md-4" style="float: left; width: 33%;" href="http://lifestyle.red.ua/2015/07/blog-post_13.html">
                <div class="blog-overlay-placeholder" style="background-image: url('/img/blog/3.jpg');">
                    <div class="blog-cover">
                        <div class="blog-overlay">
                            <span id="hover-text" class="blog_text">Распродажа купальников</span>
                        </div>
                    </div>
                </div>
            </a>
