...
<div class="row">
	<div class="col-md-10 col-md-offset-1">
		<a href="http://red.ua/category/brand/219?utm_source=site&utm_medium=banner_main&utm_campaign=mexx">
			<div style="
				height: 396px;
				width: 800px;
				background: url(../img/blocks/m15.jpg);
				background-size: 100%;
			">
...
<div class="row">
    <div class="col-md-4" style="width:35%; float: left;">
        <a href="/category/id/66/detjam/odezhda/">
			<div style="
				width: 320px;
				height: 386px;
				background: url(../img/blocks/b2152.jpg);
				background-size: 100%;
			">
    ...
    <div class="col-md-4" style="width:30%; float: left;">
        <a href="/category/id/249/zhenskaja-odezhda/zhenskoe-bele/">
			<div style="
				width: 270px;
				height: 180px;
				background: url(../img/blocks/b315.jpg);
				background-size: 100%;
			">
        ...
        <a href="/category/id/85/rasprodazha/">
			<div style="
				width: 270px;
				height: 180px;
				background: url(../img/blocks/b115.jpg);
				background-size: 100%;
				margin-top: 25px;
			">
    ...
    <div class="col-md-4" style="width:35%; float: left;">
        <a href="/category/id/141/muzhskaja-odezhda/shorty/">
			<div style="
				width: 320px;
				height: 386px;
				background: url(../img/blocks/b415.jpg);
				background-size: 100%;
			">
...
<div class="row" style="padding: 0px 30px;">
    ...
    ">
        ...
        <div class="row" style="
            margin-top: 10px;
        ">
            <a class="col-md-4" style="float: left; width: 33%;" href="http://lifestyle.red.ua/2015/09/blog-post_17.html">
                <div class="blog-overlay-placeholder" style="background-image: url('/img/blog/13.jpg');">
                    <div class="blog-cover">
                        <div class="blog-overlay">
                            <span id="hover-text" class="blog_text">Мужские регланы, кофты и кенгурушки</span>
                        </div>
                    </div>
                </div>
            </a>
            <a class="col-md-4" style="float: left; width: 33%;" href="http://lifestyle.red.ua/2015/09/blog-post_16.html">
                <div class="blog-overlay-placeholder" style="background-image: url('/img/blog/14.jpg');">
                    <div class="blog-cover">
                        <div class="blog-overlay">
                            <span id="hover-text" class="blog_text">Осенние пейзажи</span>
                        </div>
                    </div>
                </div>
            </a>
            <a class="col-md-4" style="float: left; width: 33%;" href="http://lifestyle.red.ua/2015/09/blog-post_15.html">
                <div class="blog-overlay-placeholder" style="background-image: url('/img/blog/15.jpg');">
                    <div class="blog-cover">
                        <div class="blog-overlay">
                            <span id="hover-text" class="blog_text">Женские комбинезоны по супер ценам!</span>
                        </div>
                    </div>
                </div>
            </a>
