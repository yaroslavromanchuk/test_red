	...
	<div class="row form-group">
		<div class="col-xs-10 col-xs-offset-1">
					<div class="btn-group" data-toggle="buttons" style="width:100%;">
						...
						<!--label class="btn btn-default<?php if($this->basket_contacts['delivery_type_id'] == 3) echo ' active'; ?>" style="width:25%;">
							<input class="delivery_type" name="delivery_type_id" id="delivery_type" value="3" type="radio" autocomplete="off"<?php if($this->basket_contacts['delivery_type_id'] == 3) echo ' checked'; ?>>
							<img style="height:55px;" src="/img/delivery/sv.png"/>
							Самовывоз Победы
						</label-->						
					</div>
...
<!--						<span class="rd">*</span>-->
		...
		<div class="col-xs-10 col-xs-offset-1 sv only_sv" style="<?php
			if (!in_array(@$this->basket_contacts['delivery_type_id'], array(12, 3)))
				echo 'display: none;';
		?>">
...
?>>
		<div class="col-xs-10 col-xs-offset-1">
					<div class="btn-group payment_method_container" data-toggle="buttons" style="width: 100%;" style="<?php
						if (!in_array(@$this->basket_contacts['delivery_type_id'], array(4, 8, 9, 12, 3)))
							echo 'display: none;';
					?>">
						...
						<label class="btn btn-default only_novp only_ukr" style="width: 25%;<?php
							if (in_array(@$this->basket_contacts['delivery_type_id'], array(9, 12, 3)))
								echo ' display: none;';
						?>">
