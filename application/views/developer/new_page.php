<link rel="stylesheet" type="text/css" href="/css/newpage.css?v=1.10.9.6"/>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="product-grid2">
              <div class="product-image2">
                  ...
                  <ul class="social">
                      <li><a href="#" data-tip="Quick View"><i class="fa fa-eye ion-ios-eye"></i></a></li>
                      <li><a href="#" data-tip="Add to Wishlist"><i class="fa fa-shopping-bag"></i></a></li>
                      <li><a href="#" data-tip="Add to Cart"><i class="fa fa-shopping-cart"></i></a></li>
                  </ul>
                  <a class="add-to-cart" href="">Add to cart</a>
        ...
        <div class="col-md-4 col-sm-6">
            <div class="product-grid3">
                <div class="product-image3">
                    ...
                    <ul class="social">
                         <li><a href="#" data-tip="Quick View" ><i class="fa fa-eye ion-ios-eye"></i></a></li>
                        <li><a href="#" data-tip="Quick View"><i class="fa fa-shopping-bag ion-ios-briefcase"></i></a></li>
                        <li><a href="#" data-tip="Quick View" ><i class="fa fa-shopping-cart ion-ios-cart"></i></a></li>
                    </ul>
                   <!-- <span class="product-new-label">New</span>
                      <span class="product-discount-label">20%</span>-->
                      
                </div>
                <span class="sale-icon">New</span>
                <div class="product-content">
        ...
        <div class="col-md-4 col-sm-6">
            <div class="product-grid3">
                <div class="product-image3">
                    ...
                    <ul class="social">
                         <li><a href="#" data-tip="Quick View"><i class="fa fa-eye ion-ios-eye"></i></a></li>
                        <li><a href="#"><i class="fa fa-shopping-bag ion-ios-briefcase"></i></a></li>
                        <li><a href="#"><i class="fa fa-shopping-cart ion-ios-cart"></i></a></li>
                    </ul>
                </div>
                <div class="product-content">
                    <h3 class="title"><a href="#">Women's Designer Top</a></h3>
        ...
        <div class="col-md-4 col-sm-6">
            <div class="product-grid3">
                <div class="product-image3">
                    ...
                    <ul class="social">
                         <li><a href="#"><i class="fa fa-eye ion-ios-eye"></i></a></li>
                        <li><a href="#"><i class="fa fa-shopping-bag ion-ios-briefcase"></i></a></li>
                        <li><a href="#"><i class="fa fa-shopping-cart ion-ios-cart"></i></a></li>
                    </ul>
                    <span class="product-new-label">New</span>
                ...
                <div class="product-content">
                    ...
                    <ul class="rating size">
                        <li class="fa fa-star">Size: </li>
                        <li class="fa fa-star">1</li>
                        <li class="fa fa-star">2</li>
                        <li class="fa fa-star ion-ios-star disable">3</li>
                        <li class="fa fa-star ion-ios-star disable">4</li>
                    </ul>
                </div>
            </div>
        </div>
