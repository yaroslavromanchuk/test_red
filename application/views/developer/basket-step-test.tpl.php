...
?>
<input hidden id="c_b" type="text" value="<?=$_SESSION['count_basket'] > count($_SESSION['basket'])?$_SESSION['count_basket']:count($_SESSION['basket'])?>">
<div class="card pd-50">
<?php if($this->info){
echo '<div class="col-xs-10 col-xs-offset-1">';
foreach ($this->info as $k => $v){
if($k == 'login') { echo '	<div class="alert alert-warning col-xs-6" style="float: none;text-align: center;margin: 0 auto 10px;" role="alert">
...
}else{ echo '<div class="alert alert-info">'.$v.'</div>'; }
} 
echo '</div>';
}
 ?>
...
<form method="post" action="" class="contact-form" name="basket_contacts"  data-parsley-validate>
<div id="wizard" class="col-xl-12">
 <h3>Контактные данные</h3>
            <section>
			  <div class="row">
              <div class="form-group col-xl-6">
                  <label class="form-control-label"><?=$this->trans->get('Фамилия')?>: <span class="text-danger">*</span></label>
				  <input name="middle_name" type="text" placeholder="Фамилия" id="middle_name"   required class="form-control " value="<?=@$middle_name?>">
                </div><!-- form-group -->

				<div class="form-group col-xl-6">
                  <label class="form-control-label"><?=$this->trans->get('Имя')?>: <span class="text-danger">*</span></label>
                  <input name="name" type="text" required placeholder="Имя" id="name" class="form-control" value="<?=@$name?>">
                </div>
				<div class="form-group col-xl-6">
                  <label class="form-control-label"><?=$this->trans->get('Отчество')?>: </label>
                  <input name="last_name" type="text" placeholder="Отчество"   class="form-control " value="<?=@$last_name?>">
                </div>
				<div class="form-group col-xl-6">
				...
				<div class="form-group col-xl-6">
                 ...
                 <textarea name="comments"  rows="1" class="form-control" placeholder="<?=$this->trans->get('Коментарий к заказу')?>"></textarea>
                </div>
				</div>
            </section>
<h3>Доставка и оплата</h3>
            <section>
			<div class="row">
			  <div class="parsley-radio card pd-30 col-xs-6 col-sm-12 col-md-12 col-lg-6 col-xl-6" id="delivery" >
...
<input type="radio" name="delivery" class="delivery " value="<?=$dely->getId();?>"  onChange="return loadDopFile(this);"  required style="display: inline-block;">
            ...
            <div id="ErrorDelivery"></div>
				...
				<div class="col-xs-6 col-sm-12 col-md-12 col-lg-6 col-xl-6" id="DopDelivery">
				<div class="row mg-t-20 obl hide_dop d-none">
                <label class="col-xs-6 col-sm-12 col-md-12 col-lg-12 col-xl-12 form-control-label"><?=$this->trans->get('Область')?>: <span class="text-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" name="obl" id="obl" placeholder="<?=$this->trans->get('Область')?>">
                </div>
              </div>
			  <div class="row mg-t-20 rayon hide_dop d-none">
                <label class="col-xs-6 col-sm-12 col-md-12 col-lg-12 col-xl-12 form-control-label"><?=$this->trans->get('Район')?>: <span class="text-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" name="rayon" id="rayon" placeholder="<?=$this->trans->get('Район')?>">
                </div>
              </div>
			  <div class="row mg-t-20 city hide_dop d-none">
                <label class="col-xs-6 col-sm-12 col-md-12 col-lg-12 col-xl-12 form-control-label"><?=$this->trans->get('Город')?>: <span class="text-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" name="city" id="city" placeholder="<?=$this->trans->get('Город')?>">
                </div>
              </div>
			  <div class="row mg-t-20 sklad hide_dop d-none">
                <label class="col-xs-6 col-sm-12 col-md-12 col-lg-12 col-xl-12 form-control-label"><?=$this->trans->get('Склад')?>: <span class="text-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" name="sklad" id="sklad" placeholder="<?=$this->trans->get('Склад')?>">
                </div>
              </div>
			   <div class="row mg-t-20 street hide_dop d-none">
                <label class="col-xs-6 col-sm-12 col-md-12 col-lg-12 col-xl-12 form-control-label"><?=$this->trans->get('Улица')?>: <span class="text-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" name="street" id="street" placeholder="<?=$this->trans->get('Улица')?>">
                </div>
              </div>
			  <div class="row mg-t-20 index hide_dop d-none">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" name="index" id="index" placeholder="<?=$this->trans->get('Индекс')?>">
                </div>
              </div>
			  <div class="row mg-t-20 hous hide_dop d-none">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" name="hous" id="hous" placeholder="<?=$this->trans->get('Дом')?>">
                </div>
              </div>
			  <div class="row mg-t-20 flat hide_dop d-none">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" name="flat" id="flat" placeholder="<?=$this->trans->get('Квартира')?>">
                </div>
              </div>
			  <div class="row mg-t-20 pobeda hide_dop d-none">
			  <div class="col-sm-8  mg-t-10 mg-sm-t-0">
		...
		<div class="row">
			<div class="parsley-radio card pd-30 col-xs-6 col-sm-12 col-md-12 col-lg-6 col-xl-6" id="payment" >
				 <p class="pay_heder d-none"><?=$this->trans->get('Выберите способ оплаты')?></p>
				 <div class="btn-group btn-group-toggle" id="pay_group" data-toggle="buttons">
 ...
 <h3>Подтверждение заказа</h3>
            <section>
              ...
              <div class="form-group col-xl-6">
                  <label class="form-control-label"><?=$this->trans->get('Фамилия')?>: <span class="text-danger">*</span></label>
				  <input name="middle_name1" type="text" placeholder="Фамилия"   required="" class="form-control " value="<?=@$middle_name?>">
                </div><!-- form-group -->
				</div>
            </section>
</div>
...
$.ajax({
				...
				if(res.pay){
				$('.pay_heder').removeClass('d-none');
				var pay = '';
				for (var key in res.pay){
				pay += '<label class="btn btn-danger"><input type="radio" name="payment" class="payment " value="'+key+'"    required style="display: inline-block;"><span>'+res.pay[key]+'</span></label>';
				}
				$('#pay_group').html('');
				$('#pay_group').html(pay);
				}
