...
//namespace Justin;
require_once('Exceptions/JustinApiException.php');
require_once('Exceptions/JustinAuthException.php');
require_once('Exceptions/JustinException.php');
require_once('Exceptions/JustinFileException.php');
require_once('Exceptions/JustinHttpException.php');
require_once('Exceptions/JustinResponseException.php');

require_once('Data.php');
require_once('Client.php');
require_once('Order.php');
require_once('Filter.php');
require_once('Contracts/iJustin.php');
...
class Justin extends Order implements iJustin
{
     ...
     *
     */
    protected $auth_password = 'TEdmAtIc';
    /**
     *
     * KEY API
     *
     ...
     *
     */
    protected $key = '851e2b3e-ffd5-11e9-abd8-0050569b9e7e';
    /**
     *
     * LOGIN
     *
    ...
    public function __construct($language = 'UA', $sandbox = false, $version = 'v2', $timeout = 60, $connect_timeout = 60, $timezone = 'Europe/Kiev')
    {
        ...
        $this->client = new Client($timeout, $connect_timeout);
    ...
    private function request($request, $type, $method, $data, $query = 'post')
    {
        ...
        try {
            ...
            if ($query == 'post') {
                ...
                #
                $result = $this->client->send_request(
