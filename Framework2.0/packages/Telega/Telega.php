...
use Entities\ServerResponse;
use Entities\Update;
use Exception\TelegramException;
use PDO;
...
class Telega
{
    ...
    public function handle()
    {
		...
		$response = $this->processUpdate(new Update($post, $this->bot_username));
        if ($response) {
    ...
    public function processUpdate(Update $update)
    {
        ...
        if ($update_type === 'message') {
			...
			switch ($message->getText()) {
				case "Привет": $command = 'echo'; break;
				case "привет": $command = 'echo'; break;
				//case "Как":
					//	$command = 'echo';
			//	break;
