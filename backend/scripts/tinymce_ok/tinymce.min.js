...
!function (e, t) {
			...
			a.bind = function (t, o, p, h) {
				...
				if (t && 3 !== t.nodeType && 8 !== t.nodeType) {
					for (t[c] ? g = t[c] : (g = l++, t[c] = g, s[g] = {}), h = h || t, o = o.split(" "), y = o.length; y--; )
						b = o[y], x = m, C = w = !1, "DOMContentLoaded" === b && (b = "ready"), a.domLoaded && "ready" === b && "complete" == t.readyState ? p.call(h, n({
								type: b
	...
	r(c, [], function () {
		...
		function a(e, t, n, r) {
			...
			h,
			m;
			if ((t ? t.ownerDocument || t : z) !== L && B(t), t = t || L, n = n || [], !e || "string" != typeof e)
				return n;
		...
		function d(e, t) {
			...
			for (s = e, l = [], c = N.preFilter; s; ) {
				...
				for (o in N.filter)
					!(r = ht[o].exec(s)) || c[o] && !(r = c[o](r)) || (n = r.shift(), i.push({
							value: n,
							type: o,
							matches: r
						}), s = s.slice(n.length));
		...
		function C(e, t, n, r) {
			...
			return k(e, c)(r, t, !D, n, mt.test(e)),
			n
		}
		function x() {}
		var w,
		...
		try {
			et.apply(J = tt.call(z.childNodes), z.childNodes),
		...
		B = a.setDocument = function (n) {
			var r = n ? n.ownerDocument || n : z;
			return r !== L && 9 === r.nodeType && r.documentElement ? (L = r, H = r.documentElement, D = !S(r), W.getElementsByTagName = o(function (e) {
			...
			}, W.getByName ? (N.find.ID = function (e, t) {
				...
				}), N.find.TAG = W.getElementsByTagName ? function (e, t) {
			...
			}, N.find.CLASS = W.getElementsByClassName && function (e, t) {
				return typeof t.getElementsByClassName !== Y && D ? t.getElementsByClassName(e) : void 0
			}, P = [], M = [":focus"], (W.qsa = e(r.querySelectorAll)) && (o(function (e) {
						e.innerHTML = "<select><option selected=''></option></select>",
						e.querySelectorAll("[selected]").length || M.push("\\[" + rt + "*(?:checked|disabled|ismap|multiple|readonly|selected|value)"),
						e.querySelectorAll(":checked").length || M.push(":checked")
					}), o(function (e) {
						e.innerHTML = "<input type='hidden' i=''/>",
						e.querySelectorAll("[i^='']").length && M.push("[*^$]=" + rt + "*(?:\"\"|'')"),
						e.querySelectorAll(":enabled").length || M.push(":enabled", ":disabled"),
						e.querySelectorAll("*,:x"),
						M.push(",.*:")
					})), (W.matchesSelector = e(O = H.matchesSelector || H.mozMatchesSelector || H.webkitMatchesSelector || H.oMatchesSelector || H.msMatchesSelector)) && o(function (e) {
				...
				return n ? 1 & n || R && t.compareDocumentPosition(e) === n ? e === r || I(z, e) ? -1 : t === r || I(z, t) ? 1 : A ? nt.call(A, e) - nt.call(A, t) : 0 : 4 & n ? -1 : 1 : e.compareDocumentPosition ? -1 : 1
			}
				 : function (e, t) {
				var n,
				i = 0,
				...
				for (; l[i] === c[i]; )
					i++;
				return i ? s(l[i], c[i]) : l[i] === z ? -1 : c[i] === z ? 1 : 0
			}, L) : L
		},
		...
		a.matchesSelector = function (e, t) {
			if ((e.ownerDocument || e) !== L && B(e), t = t.replace(xt, "='$1']"), W.matchesSelector && D && (!P || !P.test(t)) && !M.test(t))
				try {
					var n = O.call(e, t);
		...
		a.attr = function (e, t) {
			...
			return (e.ownerDocument || e) !== L && B(e),
			D && (t = t.toLowerCase()),
			(n = N.attrHandle[t]) ? n(e) : !D || W.attributes ? e.getAttribute(t) : ((n = e.getAttributeNode(t)) || e.getAttribute(t)) && e[t] === !0 ? t : n && n.specified ? n.value : null
		},
		a.error = function (e) {
		...
		a.uniqueSort = function (e) {
			...
			r = 0,
			i = 0;
			if (K = !W.detectDuplicates, R = !W.sortDetached, A = !W.sortStable && e.slice(0), e.sort(G), K) {
				for (; t = e[i++]; )
					t === e[i] && (r = n.push(i));
				for (; r--; )
					e.splice(n[r], 1)
		...
		N = a.selectors = {
			...
			filter: {
				...
				PSEUDO: function (e, t) {
					var n,
					r = N.pseudos[e] || N.setFilters[e.toLowerCase()] || a.error("unsupported pseudo: " + e);
	...
	r(p, [], function () {
		...
		function s(e, t, n) {
			...
			if (e = /^((static) )?([\w.]+)(:([\w.]+))?/.exec(e), a = e[3].match(/(^|\.)(\w+)$/i)[2], o = r.createNS(e[3].replace(/\.\w+$/, ""), n), !o[a]) {
				...
				e[5] && (i = r.resolve(e[5]).prototype, s = e[5].match(/\.(\w+)$/i)[1], l = o[a], o[a] = c ? function () {
	...
	r(h, [p], function (e) {
		function t(n) {
			...
			function S(e, t) {
				...
				s,
				l;
				if (t != I && (n = r()), i = R(e, t), n && n.appendChild(i), o = $(e), a = o - D[W], 0 >= a)
	...
	r(v, [c, d, l, f, h, m, g, p], function (e, n, r, i, o, a, s, l) {
		...
		return c.prototype = {
			...
			getPos: function (e, t) {
				...
				if (e = n.get(e), t = t || a.body, e) {
					if (t === a.body && e.getBoundingClientRect)
						return s = e.getBoundingClientRect(), t = n.boxModel ? a.documentElement : a.body, r = s.left + (a.documentElement.scrollLeft || a.body.scrollLeft) - t.clientTop, i = s.top + (a.documentElement.scrollTop || a.body.scrollTop) - t.clientLeft, {
							x: r,
							y: i
						};
			...
			run: function (e, t, n) {
				...
				e ? (n = n || this, e.nodeType || !e.length && 0 !== e.length ? t.call(n, e) : (i = [], u(e, function (e, o) {
	...
	r(x, [p], function (e) {
		...
		return function (e) {
			...
			k = c("non_empty_elements", "td th iframe video audio object", N),
	...
	r(w, [x, m, p], function (e, t, n) {
		...
		return function (n, i) {
			...
			o.parse = function (e) {
				...
				I = t.decode,
				F;
				for (H = new RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-\\:\\.]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), D = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, y = i.getShortEndedElements(), L = n.self_closing_elements || i.getSelfClosingElements(), b = i.getBoolAttrs(), x = n.validate, v = n.remove_internals, F = n.fix_self_closing, M = i.getSpecialElements(); s = H.exec(e); ) {
						...
						if (c = c.toLowerCase(), ":" === c.charAt(0) && (c = c.substr(1)), C = c in y, F && L[c] && d.length > 0 && d[d.length - 1].name === c && r(c), !x || (w = i.getElementRule(c))) {
							if (_ = !0, x && (S = w.attributes, k = w.attributePatterns), (E = s[8]) ? (g = -1 !== E.indexOf("data-mce-type"), g && v && (_ = !1), f = [], f.map = {}, E.replace(D, o)) : (f = [], f.map = {}), x && !g) {
								if (T = w.attributesRequired, R = w.attributesDefault, A = w.attributesForced, B = w.removeEmptyAttrs, B && !f.length && (_ = !1), A)
									for (p = A.length; p--; )
										N = A[p], m = N.name, P = N.value, "{$uid}" === P && (P = "mce_" + O++), f.map[m] = P, f.push({
											name: m,
											value: P
										});
								if (R)
									for (p = R.length; p--; )
										N = R[p], m = N.name, m in f.map || (P = N.value, "{$uid}" === P && (P = "mce_" + O++), f.map[m] = P, f.push({
												name: m,
												value: P
											}));
								if (T) {
	...
	r(_, [C, x, w, p], function (e, t, n, r) {
		...
		return function (r, l) {
			...
			u.parse = function (t, o) {
				...
				O,
				I;
				if (o = o || {}, p = {}, h = {}, T = s(i("script,style,head,html,body,title,meta,param"), l.getBlockElements()), O = l.getNonEmptyElements(), P = l.children, k = r.validate, I = "forced_root_block" in o ? o.forced_root_block : r.forced_root_block, M = l.getWhiteSpaceElements(), R = /^[ \t\r\n]+/, L = /[ \t\r\n]+$/, H = /[ \t\r\n]+/g, D = /^[ \t\r\n]+$/, v = new n({
							validate: k,
					...
					if (n)
						...
						if (s = e.name, l = e.shortEnded, c = e.attributes, a && c && c.length > 1) {
							for (f = [], f.map = {}, m = r.getElementRule(e.name), p = 0, h = m.attributesOrder.length; h > p; p++)
								u = m.attributesOrder[p], u in c.map && (d = c.map[u], f.map[u] = d, f.push({
										name: u,
										value: d
									}));
							for (p = 0, h = c.length; h > p; p++)
								u = c[p].name, u in f.map || (d = c.map[u], f.map[u] = d, f.push({
										name: u,
										value: d
									}));
							c = f
	...
	r(A, [f, k, R, g, p], function (e, n, r, i, o) {
		...
		return a.prototype = {
			...
			getBookmark: function (e, t) {
				...
				m;
				if (2 == e)
					return p = o.getNode(), f = p.nodeName, "IMG" == f ? {
						name: f,
						index: n(f, p)
					}
				...
				if (l = o.getRng(), u = a.uniqueId(), d = o.isCollapsed(), m = "overflow:hidden;line-height:0px", l.duplicate || l.item) {
					if (l.item)
						return p = l.item(0), f = p.nodeName, {
							name: f,
							index: n(f, p)
						};
					c = l.duplicate();
	...
	r(L, [f, B, p], function (e, t, n) {
		return function (r) {
			...
			function p(t, n, o) {
				function s(e, t) {
					t = t || m,
					e && (t.onformat && t.onformat(e, t, n, o), et(t.styles, function (t, r) {
				...
				function d(e, r, o) {
					...
					z.walk(e, function (e) {
						function p(e) {
							...
							w(y, "br") ? (v = 0, m.block && I.remove(e), void 0) : m.wrapper && g(e, t, n) ? (v = 0, void 0) : f && !_ && m.block && !m.wrapper && i(y) && W(C, c) ? (e = I.rename(e, c), s(e), l.push(e), v = 0, void 0) : m.selector && (et(h, function (t) {
			...
			function h(e, t, n) {
				...
				function f(e) {
					...
					n;
					e = T(e, p, G),
					h.split && (t = D(e, G), n = D(e), t != n ? (/^(TR|TD)$/.test(t.nodeName) && t.firstChild && (t = "TD" == t.nodeName ? t.firstChild || t : t.firstChild.firstChild || t), t = k(t, "span", {
									id: "_start",
									"data-mce-type": "bookmark"
								}), n = k(n, "span", {
									id: "_end",
			...
			function R(e, t, n, r) {
				...
				if ("all" != e.remove)
					for (et(e.styles, function (e, i) {
							...
							}), o = I.getAttribs(n), i = 0; i < o.length; i++)if (0 !== o[i].nodeName.indexOf("_"))
							return K;
			...
			function A(e, t) {
				...
				t.block && (U ? r == I.getRoot() && (t.list_block && w(e, t.list_block) || et(tt(e.childNodes), function (e) {
							W(U, e.nodeName.toLowerCase()) ? i ? i.appendChild(e) : i = k(e, U) : i = 0
						})) : V(e) && !V(r) && (n(e, K) || n(e.firstChild, G, 1) || e.insertBefore(I.create("br"), e.firstChild), n(e, G) || n(e.lastChild, K, 1) || e.appendChild(I.create("br")))),
			...
			function D(t, n) {
				...
				o,
				a;
				return i = t[n ? "startContainer" : "endContainer"],
				...
				3 !== i.nodeType || n || 0 !== o || (i = new e(i, r.getBody()).prev() || i),
				i
			}
			function M(t, n, o) {
				function a(e) {
					...
					return e && t.appendChild(r.getDoc().createTextNode(j)),
					t
				}
				function s(e, t) {
					for (; e; ) {
				...
				function f() {
					...
					t = l(F.getStart()),
					t && (r = u(t)),
					f && i > 0 && i < f.length && /\w/.test(f.charAt(i)) && /\w/.test(f.charAt(i - 1)) ? (s = F.getBookmark(), e.collapse(!0), e = T(e, c(n)), e = z.split(e), p(n, o, e), F.moveToBookmark(s)) : (t && r.nodeValue === j ? p(n, o, t) : (t = a(!0), r = t.firstChild, e.insertNode(t), i = 1, p(n, o, t)), F.setCursorLocation(r, i))
				}
				function m() {
					var e = F.getRng(!0),
					t,
					...
					if (d)
						if (l)
							...
							u.appendChild(I.doc.createTextNode(j)),
							u = u.firstChild;
	...
	r(H, [g, p], function (e, t) {
		...
		function (t) {
			...
			t.on("KeyUp", function (n) {
				var r = n.keyCode;
				(r >= 33 && 36 >= r || r >= 37 && 40 >= r || 45 == r || 13 == r || n.ctrlKey) && (o(), t.nodeChanged()),
		...
		return function (t) {
			function r(r) {
				...
				function v() {
					...
					B = P ? h(P) : i.create("BR"),
					e(!0) && e() ? "LI" == n ? i.insertAfter(B, t()) : i.replace(B, H) : e(!0) ? "LI" == n ? (i.insertAfter(B, t()), B.appendChild(i.doc.createTextNode(" ")), B.appendChild(H)) : H.parentNode.insertBefore(B, H) : e() ? (i.insertAfter(B, t()), d(B)) : (H = t(), N = _.cloneRange(), N.setStartAfter(T), N.setEndAfter(H), L = N.extractContents(), i.insertAfter(L, H), i.insertAfter(B, H)),
					i.remove(T),
					p(B),
					s.add()
				}
				...
				function b() {
					...
					t,
					r;
					S && 3 == S.nodeType && k >= S.nodeValue.length && (n || y() || (e = i.create("br"), _.insertNode(e), _.setStartAfter(e), _.setEndAfter(e), t = !0)),
					e = i.create("br"),
					_.insertNode(e),
					n && "PRE" == D && (!R || 8 > R) && e.parentNode.insertBefore(i.doc.createTextNode("\r"), e),
					r = i.create("span", {}, "&nbsp;"),
					e.parentNode.insertBefore(r, e),
					o.scrollIntoView(r),
					i.remove(r),
					t ? (_.setStartBefore(e), _.setEndBefore(e)) : (_.setStartAfter(e), _.setEndAfter(e)),
					o.setRng(_),
					s.add()
				}
				function C(e) {
				...
				if (!r.isDefaultPrevented() && (S = _.startContainer, k = _.startOffset, P = (a.force_p_newlines ? "p" : "") || a.forced_root_block, P = P ? P.toUpperCase() : "", R = i.doc.documentMode, A = r.shiftKey, 1 == S.nodeType && S.hasChildNodes() && (O = k > S.childNodes.length - 1, S = S.childNodes[Math.min(k, S.childNodes.length - 1)] || S, k = O && 3 == S.nodeType ? S.nodeValue.length : 0), E = x(S))) {
					if (s.beforeChange(), !i.isBlock(E) && E != i.getRoot())
						return (!P || A) && b(), void 0;
					if ((P && !A || !P && A) && (S = g(S, k)), T = i.getParent(S, i.isBlock), H = T ? i.getParent(T.parentNode, i.isBlock) : null, D = T ? T.nodeName.toUpperCase() : "", M = H ? H.nodeName.toUpperCase() : "", "LI" != M || r.ctrlKey || (T = H, D = M), "LI" == D) {
						if (!P && A)
							return b(), void 0;
						if (i.isEmpty(T))
							return v(), void 0
			...
			m({
				...
				mceInsertContent: function (t, r, i) {
					...
					if (_.invalid) {
						...
						i = s.serialize(a.parse(i.replace(/<span (id="mce_marker"|id=mce_marker).+?<\/span>/i, function () {
				...
				"Indent,Outdent": function (e) {
					...
					n = /[a-z%]+$/i.exec(t),
					t = parseInt(t, 10),
					p("InsertUnorderedList") || p("InsertOrderedList") ? g(e) : (N.forced_root_block || x.getParent(w.getNode(), x.isBlock) || E.apply("div"), i(w.getSelectedBlocks(), function (i) {
							var o;
	...
	r(O, [p], function (e) {
		...
		return t.prototype = {
			...
			toRelative: function (e) {
				...
				if (e = new t(e, {
							base_uri: n
						}), "mce_host" != e.host && n.host != e.host && e.host || n.port != e.port || n.protocol != e.protocol)
					return e.getURI();
				var i = n.getURI(),
				o = e.getURI();
				...
				on: function (e, t) {
					...
					if (t)
						for ("string" == typeof t && (t = n(t)), s = e.toLowerCase().split(" "), l = s.length; l--; )
							e = s[l], o = r._bindings, o || (o = r._bindings = {}), a = o[e], a || (a = o[e] = []), a.push(t), i[e] && (r._nativeEvents ? r._nativeEvents[e] = !0 : r._nativeEvents = {
									name: !0
						...
						if (t !== n) {
							if (d._lastHoverCtrl = t, a = t.parents().toArray().reverse(), a.push(t), n) {
								...
								for (i = s.length - 1; i >= r; i--)
									n = s[i], n.fire("mouseleave", {
										target: n.getEl()
									})
							}
							for (i = r; i < a.length; i++)
								t = a[i], t.fire("mouseenter", {
									target: t.getEl()
								})
						}
					}
		...
		return function (t) {
			...
			function s() {
				...
				if (!n || "TEXTAREA" != n.nodeName && "text" != n.type)
					return t.onAction ? t.onAction(m) : e.fire(r(), "click", {
						keyboard: !0
					}), !0
			}
			function l() {
	...
	r(Q, [X, K, W, J, j], function (e, t, n, r, i) {
		var o = e.extend({
				...
				recalc: function () {
					...
					e._super(),
					r = e.layoutRect(),
					e.settings.title && !e._fullscreen && (i = r.headerW, i > r.w && (e.layoutRect({
								w: i
							}), o = !0)),
					t && (t.layoutRect({
	...
	r(tt, [T, B, C, m, g, p], function (e, t, n, r, i, o) {
		return function (a) {
			...
			d(),
			H(),
			K && (_(), u(), p(), g(), k(), i.iOS ? (y(), M()) : f()),
			$ && i.ie < 11 && (h(), b(), x(), w(), R(), A(), B(), L()),
			i.ie >= 11 && P(),
			j && (h(), m(), v(), E(), S(), T(), D())
		}
	}),
	...
	r(it, [v, b, C, S, E, A, L, H, D, M, P, O, y, l, et, x, _, tt, g, p, nt, rt], function (e, n, r, i, o, a, s, l, c, u, d, f, p, h, m, g, v, y, b, C, x, w) {
		function _(e, t) {
		...
		return N.prototype = {
			render: function () {
				...
				function t() {
					...
					if (r.language && "en" != r.language && (r.language_url = n.editorManager.baseURL + "/langs/" + r.language + ".js"), r.language_url && e.add(r.language_url), r.theme && "function" != typeof r.theme && "-" != r.theme.charAt(0) && !S.urls[r.theme]) {
						var t = r.theme_url;
			...
			init: function () {
				function e(n) {
					...
					i,
					o;
					i = k.urls[n] || t.documentBaseUrl.replace(/\/$/, ""),
					n = L(n),
					r && -1 === B(h, n) && (R(k.dependencies(n), function (t) {
							e(t)
			...
			initContentBody: function (t) {
				...
				o.content_editable && (n.on("remove", function () {
						var e = this.getBody();
				...
				h = n.getBody(),
				h.disabled = !0,
				o.readonly || (h.contentEditable = n.getParam("content_editable_state", !0)),
				h.disabled = !1,
				n.schema = new g(o),
				n.dom = new e(p, {
						keep_values: !0,
				...
				o.protect && n.on("BeforeSetContent", function (e) {
				...
				n.contentStyles.length > 0 && (m = "", R(n.contentStyles, function (e) {
						m += e + "\r\n"
					}), n.dom.addStyle(m)),
			...
			focus: function (e) {
				...
				s = n.getDoc(),
				l;
				e || (o = r.getRng(), o.item && (a = o.item(0)), n._refreshContentEditable(), i || (b.opera || n.getBody().focus(), n.getWin().focus()), (M || i) && (l = n.getBody(), l.setActive ? l.setActive() : l.focus(), i && r.normalize()), a && a.ownerDocument == s && (o = s.body.createControlRange(), o.addElement(a), o.select())),
			...
			save: function (e) {
				...
				r = e.content,
				/TEXTAREA|INPUT/i.test(n.nodeName) ? n.value = r : (n.innerHTML = r, (i = E.getParent(t.id, "form")) && R(i.elements, function (e) {
			...
			setContent: function (e, t) {
				...
				if (t = t || {}, t.format = t.format || "html", t.set = !0, t.content = e, t.no_events || n.fire("BeforeSetContent", t), e = t.content, 0 === e.length || /^\s+$/.test(e) ? (i = n.settings.forced_root_block, i && n.schema.isValidChild(r.nodeName.toLowerCase(), i.toLowerCase()) ? e = P && 11 > P ? "<" + i + "></" + i + ">" : "<" + i + '><br data-mce-bogus="1"></' + i + ">" : P || (e = '<br data-mce-bogus="1">'), r.innerHTML = e, n.fire("SetContent", t)) : ("raw" !== t.format && (e = new o({}, n.schema).serialize(n.parser.parse(e, {
										isRootContent: !0
									}))), t.content = L(e), n.dom.setHTML(r, t.content), t.no_events || n.fire("SetContent", t)), !t.initial) {
					var a = n.dom,
					s = n.selection;
			...
			init: function (t) {
				...
				function o() {
					...
					t.oninit && (h = m = 0, d(s, function (e) {
							m++,
							e.initialized ? h++ : e.on("init", function () {
								h++,
								h == m && r(t, "oninit")
							}),
							h == m && r(t, "oninit")
	...
	r(yt, [V, vt], function (e, t) {
		...
		r = e.extend({
				init: function (e) {
					...
					t._super(e),
					t.canFocus = !0,
					e.tooltip && r.tooltips !== !1 && t.on("mouseenter mouseleave", function (n) {
			...
			recalc: function (e) {
				...
				if (x = {}, x[E] = 0 > d ? i[E] - d + i[B] : i[R] - d + i[B], x[P] = _ + i[z], x[L] = i[R] - d, x[W] = _, x.minW = U(x.minW, i.maxW), x.minH = U(x.minH, i.maxH), x.minW = V(x.minW, i.startMinWidth), x.minH = V(x.minH, i.startMinHeight), !i.autoResize || x.minW == i.minW && x.minH == i.minH) {
					...
					for (C = d / u, w = o[T], x = {}, 0 === u && ("end" == l ? w = d + o[T] : "center" == l ? (w = Math.round(i[R] / 2 - (i[R] - d) / 2) + o[T], 0 > w && (w = o[T])) : "justify" == l && (w = o[T], c = Math.floor(d / (r.length - 1)))), x[H] = o[I], t = 0, n = r.length; n > t; t++)
						p = r[t], h = p.layoutRect(), y = h.maxFlexSize || h[E], "center" === s ? x[H] = Math.round(i[D] / 2 - h[M] / 2) : "stretch" === s ? (x[M] = V(h[P] || 0, i[D] - o[I] - o[F]), x[H] = o[I]) : "end" === s && (x[H] = i[D] - h[M] - o.top), h.flex > 0 && (y += Math.ceil(h.flex * C)), x[N] = y, x[S] = w, p.layoutRect(x), p.recalc && p.recalc(), w += y + c
	...
	r(Dt, [V, yt, X, p, st, g], function (e, t, n, r, i, o) {
		function a(e) {
			function t(t) {
				...
				c === !1 ? "" : (c || (c = "font-family font-size font-weight text-decoration text-transform color background-color border border-radius"), (t = e.formatter.get(t)) ? (t = t[0], r = t.block || t.inline || "span", i = o.create(r), s(t.styles, function (e, t) {
							e = n(e),
							e && o.setStyle(i, t, e)
	...
	a([l, c, u, d, f, p, h, m, g, v, y, b, C, x, w, _, N, E, S, k, T, R, A, B, L, H, D, M, P, O, I, F, z, W, V, U, q, j, $, K, G, Y, X, J, Q, Z, et, tt, nt, rt, it, ot, at, st, lt, ct, ut, dt, ft, pt, ht, mt, gt, vt, yt, bt, Ct, xt, wt, _t, Nt, Et, St, kt, Tt, Rt, At, Bt, Lt, Ht, Dt, Mt, Pt, Ot, It, Ft, zt, Wt, Vt, Ut, qt, jt, $t, Kt, Gt, Yt, Xt, Jt])
}
(this);
