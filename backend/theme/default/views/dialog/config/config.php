...
//setlocale(LC_CTYPE, 'ru_UA'); //correct transliteration
...
$config = array(
    ...
    */
    ...
    |
    */
    'upload_dir' => isset($_GET['upload_dir'])?$_GET['upload_dir']:'/',
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    'current_path' => isset($_GET['current_path'])?$_GET['current_path']:'../../../../../',
    ...
    |
    */
    'thumbs_base_path' => isset($_GET['thumbs_base_path'])?$_GET['thumbs_base_path']:'../../../../../thumbs/',
