...
//'user_id' => $ws-->id?$this->user->id:0,
	...
	*/
	...
	|
	*/
	'current_path' => '../../../storage/images/RED_ua/NewFolder2',
	...
	*/
	...
	'ftp_user'         => "yarik",
	'ftp_pass'         => "12345",
//	'ftp_base_folder'  => "http://" . $_SERVER['HTTP_HOST']."/responsivefilemanager.com/html",
	'ftp_base_url'     => "ftp://" . $_SERVER['HTTP_HOST'],
	/* --------------------------------------------------------------------------
