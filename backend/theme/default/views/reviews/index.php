...
<b><span><?=$r->name.' | '.$r->mail.' |	'.$r->date_add?></span></b> <?php if(@$this->type and ($this->type == 1 or $this->type == 3 or $this->type == 5)) echo '<img src="/backend/views/reviews/good.gif"/><a href="?good_comment='.$r->id.'">Одобрить</a> | '; ?>
<?php if($this->type and $this->type != 5) echo '<img src="/backend/views/reviews/delete.gif"/><a href="?hide_comment='.$r->id.'">Скрыть</a> | '; ?><img src="/backend/views/reviews/delete.gif"/><a href="?delete_comment=<?=$r->id?>" >Удалить</a></br></br>
<?=$r->text?>
</li>
