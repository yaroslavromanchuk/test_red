...
<html>
	...
	<table  style="min-width:700px;" align="center" border="0" cellpadding="0" cellspacing="0">
	<tr>
	<td style="border-bottom: 2px solid #e30613;padding:10px;background: black;">
	...
	<table style="min-width:700px;font-family: monospace;" >
	<tbody style="min-width:700px;">
	<tr>
	<?php 
...
<br><span style="margin-left: -5px;"><?=$menui->getEmail()?></span></a></td>
    ...
    color: #605f60;"   target="_blank"><img src="https://<?=$dname?>/backend/img/email/cat/brands.png" style="width:40px;margin-top: 5px;"><br>Бренды</a>
        ...
        <tr>
            <td>
<table  align="center" border="0" cellpadding="0" cellspacing="0" style="font-size:12px;color:#6c6c6c;width:100%;min-width:700px;">
