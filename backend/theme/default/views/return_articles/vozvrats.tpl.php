...
<form action="" method="get" id="myform">
    ...
    <option value="3" <?php if (isset($_GET['delivery']) and $_GET['delivery'] == '3') echo 'selected="selected"';?>>пр.Победы</option>
	 <option value="5" <?php if (isset($_GET['delivery']) and $_GET['delivery'] == '5') echo 'selected="selected"';?>>ул.Строителей</option>
         ...
         <option value="18" <?php if (isset($_GET['delivery']) and $_GET['delivery'] == '18') echo 'selected="selected"';?>>Justin</option>
</select>
</td>
	<td>
...
<?php 
if ($this->getArticles()) {
$deli = array( 3 => 'Победа', 5 => 'Строителей', 4=>'УкрПочта', 9=>'Курьер', 8=>'НП', 16=>'НП:НП', 18=>'Justin');
?> 
<script>
       $(document).ready(function() {
     $("body").keypress(function(e) {
         switch(e.originalEvent.code){
             case 'NumpadMultiply': if($('.chekAll').is(":checked")){
