    ...
    <span aria-hidden="true">&times;</span>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary">Сохранить</button>
                    ...
                    <div class="col-xs-6">
                       <label class="rdiobox">
                            <input name="customer_status_id" id='activ' type="radio"  value="0" <?php if ($this->sub->getCustomerStatusId() != 2) { ?>checked="checked"<?php } ?>>
                            <span>Активный</span>
                        </label>
                        <label class="rdiobox">
                            <input name="customer_status_id" id='ban' type="radio"  value="2" <?php if ($this->sub->getCustomerStatusId() == 2) { ?>checked="checked"<?php } ?>>
                            <span>Бан</span>
                        </label>
                    ...
                    <div class="col-xs-1">
                     ...
                     <span  class="col-xs-6"><?php if ($this->sub->bloсk_np_n == 1){ echo $this->sub->getBanComment(); }?></span>
                </div>
                     <div class="form-group">
                    ...
                    <span class="col-xs-6"><?php if ($this->sub->block_cur == 1){ echo $this->sub->getBanComment(); }?></span>
                </div>
                    <div class="form-group">
                    ...
                    <div class="col-xs-1">
                     ...
                     <span class="col-xs-6"><?php if($this->sub->block_m == 1){ echo $this->sub->getBanComment(); }?></span>
                </div>
                    <div class="form-group">
                    ...
                    <div class="col-xs-1">
                     ...
                     <span class="col-xs-6"><?php if($this->sub->block_quick == 1){ echo $this->sub->getBanComment(); }?></span>
                </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-xs-1">
                     ...
                     <span  class="col-xs-6"><?php if ($this->sub->bloсk_justin == 1){ echo $this->sub->getBanComment(); }?></span>
                </div>
...
<table class="table">
    ...
    <tr>
        ...
        <td><?=$order->countArticles()?></td>
        <td><?=Number::formatFloat(($order->amount+$order->deposit), 2) . ' грн'?></td>
        <td>
            <?=$order->getDeliveryTypeId()?$order->getDeliveryType()->getName():""?><br/>
            <?php if($order->getNakladna()){ ?>
            Накладная №: <?=$order->getNakladna()?>
            <?php } ?>
        </td>
    </tr>
    <?php } ?>
...
$(":radio").click(function(){$('.ban_coment').slideToggle();});
