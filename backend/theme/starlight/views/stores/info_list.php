...
<div class="card pd-20 pd-sm-40">
          ...
          <a href="/admin/stores-info/edit/id/"  class="p-1 m-2"><i class="icon ion-ios-create-outline">Новая запись</i></a>
		  ...
		  <thead class="bg-info">
                ...
                <tbody id="sortable">
                    ...
                    <tr id="<?=$n->id?>">
                        ...
                        <td>
                            <a href="/admin/stores-info/edit/id/<?=$n->id?>/" data-tooltip="tooltip" target="blank" class="d-inline-block" title="" data-original-title="Редактировать">
				  <i class="menu-item-icon icon ion-md-paper tx-22  m-2"></i>
				  </a><a href="/admin/stores-info/delete/id/<?=$n->id?>/" data-tooltip="tooltip" class="d-inline-block" target="blank" title="" data-original-title="Удалить">
