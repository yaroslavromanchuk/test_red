		...
		<table border="0" cellpadding="0" cellspacing="0" width="700" align="center" style="background:#fff;border-collapse:collapse;">
			...
			<!--tr>
				<td style="padding: 0 0 0 10px;">
					<a href="/" class="logo"><img src="http://<?php echo $dname?>/img/_red_logo.png" alt="RED" height="50" width="130"/></a>
				</td>
				<td>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="700" align="center" style="border:1px solid #e4e4e4; background:#fff;border-top: none;padding-top: 5px;border-collapse:collapse;">
			<tr>
				<td style="color:#383838; padding:0">
					<p><?php if(@$this->post->intro) echo stripslashes($this->post->intro);?></p>
				</td>
			</tr>
			...
			<tr>
				<td style="color:#383838; padding:0"><?php if(@$this->post->ending) echo stripslashes($this->post->ending);?></td>
			</tr>
			...
			<tr>
				...
				<span>Вы получили это письмо на адрес <?php echo $this->email;?>, потому что оформили подписку на сайте Red.ua. Если Вы больше не хотите получать эти письма, нажмите </span><a href="http://<?php echo $dname?>/subscribe/?email_to_black=<?php echo $this->email;?>"><span style="color:#383838">тут</span></a> <span>для того чтобы отписаться.</span>
				</td>
			</tr>
		</table>
	</body>
