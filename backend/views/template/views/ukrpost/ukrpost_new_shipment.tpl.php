    ...
    <span aria-hidden="true">&times;</span>
               ...
               <?php  }
                 ?>
                  ...
                  <?php if($this->client->uuid){ ?>
                 <p class="font-weight-bold text-dark">Контактні дані:</p>
                 <div class="row row-xs">
                  ...
                  <input type="text" class="form-control" required name="lastName" value="<?=$this->client->lastName?>" >
                </div>
                     </div>
                     <div class="col-lg-3">
                   <div class="form-group">
 <label class="form-control-label"> Ім'я: <span class="tx-danger">*</span></label>
    <input type="text" class="form-control" name="firstName" required value="<?=$this->client->firstName?>" >
                </div>
                     </div>
                       <div class="col-lg-3">
                   <div class="form-group">
<label class="form-control-label"> По-батькові: </label>
                  <input type="text" class="form-control" name="middleName" value="<?=$this->client->middleName?>" >
...
<label class="form-control-label"> Телефон: <span class="tx-danger">*</span></label>
                  <input type="text" class="form-control" required name="phoneNumber" value="<?=$this->client->phoneNumber?>" >
                </div>
                </div><!-- col-lg-3 -->
