    ...
    <table id="pageslist" cellpadding="2" cellspacing="0">
        ...
        foreach ($this->getMenuf() as $menu) {
            ...
            <tr class="<?php echo $row;?>">
                <td class="kolomicon">
                    <a href="<?php echo $this->path;?>footermenu/delete/<?php echo $menu->getId();?>/" onclick="return confirm('Вы действиельно хотите удалить пункт меню?')"><img src="<?php echo SITE_URL;?>/img/icons/remove-small.png" alt="Удалить" width="24" height="24" /></a>
                </td>
<td class="kolomtitle">
