    ...
    <table id="editpage" cellpadding="5" cellspacing="0">
        ...
        <tr>
            ...
            <td><input name="extra_url" type="text" class="form-control input w500" id="paginatitle"
                       value="<?php echo @$this->post->extra_url ? $this->post->extra_url : 'utm_source=baby_email_'.date('d.m.Y').'&utm_medium=email&utm_content=Baby_Subscriber&utm_campaign=Baby_Subscriber'; ?>"/>
					   <input name="unsubscribe" hidden type="text" 
                       value="<?=@$this->post->unsubscribe ? $this->post->unsubscribe : '&utm_source=unsubscribe_'.date('d.m.Y').'&utm_medium=email&utm_content=Baby_Subscriber&utm_campaign=Baby_Subscriber'?>"/>
					   </td>
        </tr>        
        <tr>
