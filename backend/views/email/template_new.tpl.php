...
<html>
	...
	<a href="https://<?=$dname.$this->getExtraUrl()?>"><img src="https://<?=$dname.$this->files?>img/email/logo.png" alt="RED"  style="width:75px;height:30px;"></a>
	</span>
	...
	<a href="http://instagram.com/red_ua"><img src="https://<?=$dname.$this->files?>img/email/inst.png" alt="instagramm"  style="width:30px;padding: 0px 1px;"></a>
	<a href="https://www.youtube.com/user/SmartRedShopping"><img src="https://<?=$dname.$this->files?>img/email/youtube.png" alt="youtube" style="width:30px;padding: 0px 1px;"></a>
	<a  href="https://www.red.ua/blog/"><img src="https://<?=$dname.$this->files?>img/email/blog.png" alt="blog"  style="width:30px;padding: 0px 1px;"></a>
	</span>
	</td>
	</tr>
	<tr>
