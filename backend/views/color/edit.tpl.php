...
<form method="POST" action="<?php echo $this->path;?>color/id/<?php echo (int)$this->sub->getId();?>/"   enctype="multipart/form-data">
    <table id="editpage" cellpadding="5" cellspacing="0">
        ...
        <tr>
            ...
            <td><input name="color" type="text" class="formfields"
