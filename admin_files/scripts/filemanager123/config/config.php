...
$base_url = $_SERVER['SERVER_NAME'];  // base url (only domain) of site (without final /). If you prefer relative urls leave empty
$upload_dir = '/storage/images/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../storage/images/'; // relative path from filemanager folder to upload folder (with final /)
