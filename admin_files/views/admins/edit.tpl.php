...
<label><input class="rv_no" type="radio" <?php if (@$this->rights[$pages->getId()]['view'] == 0) { ?>checked="checked"<?php } ?>
                                                              name="view[<?=$pages->getId()?>]" value="0"> Нет</label>
...
$('.rr_no').click();
$('.rv_no').click();
if(c == 5){//комплектовщик
var v = [402, 11, 322, 193, 10, 355, 353, 447, 451, 415, 12, 323, 425, 5, 188, 428, 488, 489, 475, 479, 495 ];//страницы
var r = [321, 332, 333, 338, 380, 327, 4, 402, 11, 322, 196, 194, 346, 360, 416, 193, 345, 366, 335, 418, 379, 363, 307, 344, 412, 411, 10, 355, 382, 334, 353, 441, 415, 12, 324, 325, 425, 5, 430, 429, 188, 428, 339, 488, 489, 476, 475, 479, 481, 495];//модули
}else if(c == 6){//пункт выдачи
var v = [ 402, 403, 11, 322, 193, 10, 415, 12, 323, 425, 5, 188, 428, 495 ];//страницы
var r = [321, 332, 333, 338, 380, 331, 393, 347, 327, 4, 350, 403, 402, 11, 322, 20, 390, 196, 364, 394, 194, 346, 195, 360, 395, 416, 193, 345, 366, 335, 418, 379, 363, 307, 412, 411, 10, 382, 334, 441, 46, 415, 12, 323, 324, 325, 425, 5, 189, 190, 188, 339, 428, 491, 493, 495];//модули
}else if(c == 7){//возвраты
var v = [402, 403, 11, 322, 193, 12, 10, 474, 425, 5, 188, 495];//страницы
var r = [412, 321, 332, 333, 327, 4, 403, 402, 11, 322, 196, 194, 346, 195, 360, 395, 416, 193, 366, 335, 418, 363, 307, 12, 411, 10, 382, 334, 474, 5, 25, 192, 191, 384, 189, 190, 188, 339, 428, 491, 492, 495];//модули
}else if(c == 8){//оператор
var v = [5, 451, 193, 423, 188, 403, 402,  474, 495, 323, 322, 386, 10, 11, 12, 428];//страницы

var r = [321, 332, 333, 4, 386, 389, 423, 492, 403, 402, 11, 322, 196, 364, 394, 194, 346, 195, 360, 395, 416, 193, 345, 335, 363, 476, 307, 344, 412, 10, 474, 382, 12, 495, 323, 324, 325, 425, 25, 188, 339, 428];//модули
}else if(c == 3 || c == 4){//
$('.rr_yes').click();
$('.rv_yes').click();
return false;
