...
var v = [423, 402, 403, 11, 322, 193, 10, 474,  451, 12, 323, 425, 5, 188, 428, 495, 386];//страницы
var r = [321, 332, 333, 4, 423, 403, 402, 11, 322, 196, 364, 394, 194, 346, 195, 360, 395, 416, 193, 345, 335, 363, 307, 344, 412, 10, 474, 382, 12, 323, 324, 325, 425, 25, 188, 339, 428, 476, 492, 495, 386, 389];//модули
}else if(c == 3 || c == 4){//
$('.rr_yes').click();
$('.rv_yes').click();
return false;
