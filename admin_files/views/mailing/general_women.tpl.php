...
<p>Рассылка будет
    отправлена <?php echo wsActiveRecord::useStatic('Subscriber')->count(array('active' => 1, 'confirmed is not null', 'women'=>1));?>
    подписчикам.</p>
<input type="hidden" id="all_subject" name="all_subject" value="<?php echo wsActiveRecord::useStatic('Subscriber')->count(array('active' => 1, 'confirmed is not null', 'women'=>1));?>"/>
...
<script type="text/javascript">
	function loadArticles(category_id, i) {
		...
		$.post('/admin/womenmailing/', data_to_post, function (data) {
...
<form method="POST" id="mail_form" action="<?php echo $this->path; ?>womenmailing/" target="_blank">
