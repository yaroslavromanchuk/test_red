 ...
 <div class="sl-page-title"><h5><?=$this->getCurMenu()->getTitle()?></h5></div>
  ...
  <input type="text" class="form-control" name="articul" id="articul"  value="" autofocus placeholder="Артикул">
...
<div class="row">
 ...
 <div class="col-xl-12">
<p>
<a  id="a" href="" class="shoping" data-toggle="tooltip"  title="" target="_blank"  ></a> 
<a id="ed" href="" title="Редактировать" data-placement="top" data-original-title="Tooltip on top" data-toggle="tooltip"  target="_blank"></a> 
<a id="ist" href="" class="history" data-toggle="tooltip"  title="История" target="_blank"></a> 
<a id="tov" href="" title="Товары" data-toggle="tooltip"  target="_blank"></a> 
</p>
</div>
 </div>
 <table id="pageslist" cellpadding="2" cellspacing="0" align="center" class="table">
</table>
...
$('#ed').html('<i class="menu-item-icon icon ion-ios-compose-outline tx-22 pd-5"></i>');
$('#a').html('<i class="menu-item-icon icon ion-ios-cart-outline  tx-22 pd-5"></i>');
//$('#ist').attr("href", "/admin/articlehistory/id/"+res.id);
$('#ist').html('<i class="menu-item-icon icon ion-ios-information-outline  tx-22 pd-5"></i>');

$('.history').data("id", res.id);
$('.shoping').data("id", res.id);

$('#tov').attr("href", "/admin/shop-articles/?search=&search_artikul="+z);
$('#tov').html('<i class="menu-item-icon icon ion-ios-albums-outline  tx-22 pd-5"></i>');
