...
var chat = {
	...
	render : function(template,params){
		...
		switch(template){
			case 'loginTopBar':
				arr = [
				'<span><img src="avatars/',params.gravatar,'.jpg" width="23" height="23"  onClick="avatarOpen();" title="Сменить аватар" />',
			...
			case 'chatLine':
				arr = [
					'<div class="chat chat-',params.id,' rounded"><span class="gravatar"><img src="avatars/',params.gravatar,
					'.jpg" width="23" height="23" onload="this.style.visibility=\'visible\'" />','</span><span class="author">',params.author,
					':</span><span class="text">',params.text,'</span><span class="time">',params.time,'</span></div>'];
					localStorage.chat = params.text;
					
			break;
			
			case 'user':
				arr = [
					'<div class="user" title="',params.name,'"><img src="avatars/',
					params.gravatar,'.jpg" width="50" height="50" onClick="avatarOpen();" onload="this.style.visibility=\'visible\'" /></div>'
				];
			break;
		}
